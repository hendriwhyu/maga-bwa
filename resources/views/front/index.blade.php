...
@section('content')
	<body class="font-[Poppins] pb-[72px]">
        ...
        @if(isset($entertainment_articles) && isset($entertainment_featured_articles))
        ...
        @if(isset($business_articles) && isset($business_featured_articles))
        ...
        @if(isset($automotive_articles) && isset($automotive_featured_articles))
